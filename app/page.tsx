  ...
  return (
    <main>
      <section className="hero">
        <div className="hero-kicker">ISSUE 001 · PRIVATE PREVIEW · 2026</div>
        <div className="hero-title-wrap">
          <h1>LUXURY<br/><em>REGISTRY</em></h1>
          <p className="hero-deck">A living index of fashion objects—streetwear, designer denim, footwear and accessories—cataloged with the discipline of an archive and the attitude of a magazine.</p>
        </div>
        <div className="hero-actions"><Link href="/shop" className="primary-link">ENTER THE REGISTER <span>↗</span></Link><span className="hero-number">LR / 625</span></div>
      </section>
      ...
      <section className="manifesto" id="about">
        ...
        <div className="manifesto-copy"><p>Luxury Registry is being built as a structured fashion index: editorial enough to browse, rigorous enough to operate as product data.</p><p>Every object receives a registry number, market context and a verification trail before commerce is enabled.</p></div>
      </section>
